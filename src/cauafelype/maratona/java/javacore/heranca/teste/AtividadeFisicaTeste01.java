...
import cauafelype.maratona.java.javacore.heranca.dominio.CrossFit;
...
public class AtividadeFisicaTeste01 {
    public static void main(String[] args) {
        ...
        AtividadeFisica crossfitHoje = new CrossFit("Pular caixa", 60, 2);
        AtividadeFisica[] treinoDeHoje = new AtividadeFisica[]{cardioHoje, musculacaoHoje, crossfitHoje};
